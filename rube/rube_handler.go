...
var words = []string{
	"gravity", "inequality", "vapor", "tidal", "poverty",
	"mineral", "eclipse", "migration", "erosion", "lattice",
	"mortality", "sediment", "solvent", "literacy", "current",
	"orbital", "urbanization", "pressure", "cascade", "fertility",
	"basin", "ferment", "governance", "aquifer", "inflation",
}
